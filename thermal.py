...
producer = client.create_producer(topic='persistent://public/default/pi-thermal' ,schema=JsonSchema(thermal),properties={"producer-name": "thermal-py-sensor","producer-id": "thermal-sensor" })
