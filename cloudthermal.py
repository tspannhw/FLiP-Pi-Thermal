...
producer = client.create_producer(topic=args.topic ,schema=JsonSchema(thermal),properties={"producer-name": "thermal-py-sensor","producer-id": "thermal-sensor" })

#producer = client.create_producer(topic='persistent://public/default/pi-thermal' ,schema=JsonSchema(thermal),properties={"producer-name": "thermal-py-sensor","producer-id": "thermal-
sensor" })
